...
# Service URLs
DICE_ROLLER_URL = "http://dice-roller-stage5:8000"
DIE_SERVICE_URL = "http://die-service-stage5:8000"

# Cache for available die types
available_die_types = ["fair", "risky", "extreme"]  # Default fallback
...
async def startup_event():
    logger.info("Frontend API starting up (Stage 5 - with database backend)")
...
async def root():
    ...
    <html>
    <head>
        <title>Dice Roller Frontend - Stage 5</title>
        <style>
            body {{
    ...
    <body>
        <div class="container">
            <h1>🎲 Dice Roller <span class="stage-badge">Stage 5</span></h1>
            <p>Roll dice with optional async/concurrent rolling</p>

            <div class="info">
                <strong>New Feature:</strong> Database backend with PostgreSQL!<br>
                <strong>Architecture:</strong> Frontend → Dice Roller → Die Service → PostgreSQL
            </div>
