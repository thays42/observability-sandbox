#!/usr/bin/env python3
"""
Performance comparison script for Stage 5.
...
Tests async rolling with database backend.
"""
...
# Configuration
DICE_ROLLER_URL = "http://localhost:8110"  # Direct to dice-roller for stage5
DIE_TYPE = "fair"
NUM_ROLLS = 10
...
async def run_performance_test():
    ...
    logging.info("=" * 70)
    logging.info("Stage 5: Async Rolling Performance Test (with Database)")
    logging.info("=" * 70)
